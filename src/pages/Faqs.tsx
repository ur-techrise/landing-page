...
export default function Faq() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Techrise hackathon will take place in March 2024 at the University of Rwanda, KIST campus. It will be fully in-person this 2024 season!",
    },
    {
  ...
  return (
    ...
    >
      ...
      <div className=" ml-4 grid grid-cols-1 md:grid-cols-2 justify-center">
        {faqs.map((faq, index) => (
